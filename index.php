            ...
            <div class="bottomAreaMainDiv">
                <div class="fdiv1">
                    ...
                    <div style="display: inline-block; margin-top: 55px; transform: skew(-15deg); ">
                        <div class="bottomFont2"><a href="#"><i class="fa-brands fa-facebook-f" style="color: #ffffff; transform: skew(15deg); "></i></a></div>
                        <div class="bottomFont2"><a href="#"><i class="fa-brands fa-twitter" style="color: #ffffff;  transform: skew(15deg); "></i></a></div>
                        <div class="bottomFont2"><a href="#"><i class="fa-brands fa-youtube" style="color: #ffffff;  transform: skew(15deg); "></i></a></div>
                        <div class="bottomFont2"><a href="#"><i class="fa-brands fa-instagram" style="color: #ffffff;  transform: skew(15deg); "></i></a></div>
                    </div>
                </div>
                <div class="fdiv2">
                    <div>
